# Historical bridge comparison from August 20, 2026

Superseded by [the current comparison](../BRIDGE.md). The original text follows,
with relative links adjusted for this archive directory. Its branch positions,
interface descriptions and failures are historical observations.
