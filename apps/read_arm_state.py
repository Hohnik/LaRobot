...
"""Read all seven joints through the whole-arm CHAIN. No gravity comp, no motion.
    ...
    uv run apps/read_arm_state.py                # dry run
    uv run apps/read_arm_state.py --yes          # enables all 7 motors, reads, disables
    uv run apps/read_arm_state.py --yes --seconds 10   # stream state
