...
"""The first commanded motion on this arm. ONE motor, small, slow, bounded.
    ...
    uv run apps/move_one_motor.py                  # dry run: prints the exact plan
    uv run apps/move_one_motor.py --yes            # MOVES motor 6 by ±0.05 rad
    uv run apps/move_one_motor.py --yes --delta 0.15
