...
"""Find the jaws' real limits ONCE, gently, and save them. Then never again.
    ...
    uv run apps/calibrate_gripper.py              # dry run
    uv run apps/calibrate_gripper.py --yes        # calibrates, saves the result
...
def main() -> int:
    ...
    # Start from a known state — see apps/read_arm_state.py for why.
