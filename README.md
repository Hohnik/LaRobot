...
> ---
>
> ## ⚠️ Everything below is the project's EARLY HISTORY (sessions 1-2, 2026-08-07/10)
>
> It is kept because the rebuild needs its reasoning — especially §2.1 (how macOS drives CAN at all) and §6 (what was genuinely unknown at the start). **None of it is the live state.** The live state is [docs/HANDOFF.md](docs/HANDOFF.md), always.
