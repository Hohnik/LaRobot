#!/usr/bin/env python3
"""Do the tests in tests/test_fake_arm.py actually have teeth?

    uv run checks/falsify_fake_arm.py
...
if __name__ == "__main__":
    print("Falsifying tests/test_fake_arm.py — each sabotage must make a test fail.")
